...
func TestClassifyCommand_Npx(t *testing.T) {
	tests := []struct {
		...
		{name: "partial major", argv: []string{"npx", "pkg@1"}, kind: KindNPM, status: StatusMutable, reason: "floating-range"},
		{name: "partial major.minor", argv: []string{"npx", "pkg@1.2"}, kind: KindNPM, status: StatusMutable, reason: "floating-range"},
		{name: "wildcard major", argv: []string{"npx", "pkg@1.x"}, kind: KindNPM, status: StatusMutable, reason: "floating-range"},
		{name: "wildcard patch", argv: []string{"npx", "pkg@1.2.x"}, kind: KindNPM, status: StatusMutable, reason: "floating-range"},
		{name: "exact version", argv: []string{"npx", "-y", "chrome-devtools-mcp@1.9.0"}, kind: KindNPM, status: StatusPinned, reason: "exact-version"},
		{name: "prerelease exact", argv: []string{"npx", "pkg@1.2.3-rc.1"}, kind: KindNPM, status: StatusPinned, reason: "exact-version"},
		...
		{name: "scoped partial", argv: []string{"npx", "-y", "@scope/pkg@1.2"}, kind: KindNPM, status: StatusMutable, reason: "floating-range"},
		{name: "scoped wildcard", argv: []string{"npx", "@scope/pkg@1.2.x"}, kind: KindNPM, status: StatusMutable, reason: "floating-range"},
		...
		{name: "repeated package last pinned", argv: []string{"npx", "--package=unpinned", "--package=pinned@1.2.3", "pinned"}, kind: KindNPM, status: StatusMutable, reason: "missing-version"},
		{name: "repeated package first pinned", argv: []string{"npx", "-p", "pkg@1.2.3", "-p", "other"}, kind: KindNPM, status: StatusMutable, reason: "missing-version"},
		{name: "repeated package both pinned", argv: []string{"npx", "--package=foo@1.0.0", "--package=bar@2.0.0", "foo"}, kind: KindNPM, status: StatusPinned, reason: "exact-version"},
		{name: "package flag local path", argv: []string{"npx", "--package=pkg@1.2.3", "--package=./local-tool", "run"}, kind: KindNPM, status: StatusNotAssessed, reason: "local-path"},
		{name: "package flag variable", argv: []string{"npx", "--package=${var:PKG}", "run"}, kind: KindNPM, status: StatusNotAssessed, reason: "variable"},
...
func TestClassifyCommand_Uvx(t *testing.T) {
	tests := []struct {
		...
		{name: "two component equality", argv: []string{"uvx", "httpie==1.2"}, status: StatusPinned, reason: "exact-version"},
		...
		{name: "with extra unversioned", argv: []string{"uvx", "--with", "httpx", "httpie==1.2.3"}, status: StatusMutable, reason: "missing-version"},
		{name: "with extra pinned", argv: []string{"uvx", "--with", "httpx==0.27.0", "httpie==1.2.3"}, status: StatusPinned, reason: "exact-version"},
		{name: "with equals unversioned", argv: []string{"uvx", "--with=httpx", "httpie==1.2.3"}, status: StatusMutable, reason: "missing-version"},
		{name: "with editable local", argv: []string{"uvx", "--with-editable", "./local-tool", "httpie==1.2.3"}, status: StatusNotAssessed, reason: "local-path"},
		{name: "with editable equals local", argv: []string{"uvx", "--with-editable=./local-tool", "httpie==1.2.3"}, status: StatusNotAssessed, reason: "local-path"},
		{name: "with extra variable", argv: []string{"uvx", "--with", "${var:DEP}", "httpie==1.2.3"}, status: StatusNotAssessed, reason: "variable"},
