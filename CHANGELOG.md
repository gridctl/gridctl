...
- Container stdio MCP servers no longer report a phantom allocated host port in apply results. Stdio workloads continue to publish no ports, and HTTP/SSE port allocation is unchanged.
