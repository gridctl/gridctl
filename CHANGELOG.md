...
- Document A2A fields, tools, capability bounds and secrecy, credential origins, bounded card freshness, immutable card/identity pins, and downstream shared-memory limits. Add an example stack and private-file CLI guidance; distinguish remote interrupted task states from completed MCP/REST invocations (#1185).
