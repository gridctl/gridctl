...
- Pin runnable example stacks and public setup snippets to reviewed image digests and exact package versions, document placeholder exceptions and quarterly pin review, and add `task examples:refs` plus Gatekeeper enforcement that fails unpinned selectors without making unrelated example warnings fatal (#1229).
