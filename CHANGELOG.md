...
- Add a downstream Python 3.12 MCP runtime base recipe (`ghcr.io/gridctl/mcp-runtime-python`) with locked-project and hashed-requirements derivatives, tini init, UID/GID 10001, and a dedicated OCI workflow. The image is a foundation, not a ready server; generated Python 3.10-3.13 builds are unchanged. Supported tags wait on hosted amd64/arm64 acceptance, candidate publication, and anonymous evidence (#1230).
